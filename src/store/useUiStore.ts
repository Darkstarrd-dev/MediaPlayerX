...
export const DEFAULT_SETTINGS: AppSettings = {
  ...
  wdSwinTaggerModelPath: 'Z:/Playground/CurrentWorking/wd-swinv2-tagger-v3/model.onnx',
  wdSwinTaggerAutoTagOccurrenceThreshold: 2,
  wdSwinTaggerAutoTagGeneralMinScore: 0.35,
  wdSwinTaggerAutoTagCharacterMinScore: 0.75,
  wdSwinTaggerAutoTagIncludeRating: false,
