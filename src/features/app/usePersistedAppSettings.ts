...
export function usePersistedAppSettings({
  ...
  useSettingsPersistence({
    settings: {
      ...
      wdSwinTaggerAutoTagGeneralMinScore: settings.wdSwinTaggerAutoTagGeneralMinScore,
      wdSwinTaggerAutoTagCharacterMinScore: settings.wdSwinTaggerAutoTagCharacterMinScore,
      wdSwinTaggerAutoTagIncludeRating: settings.wdSwinTaggerAutoTagIncludeRating,
      wdSwinTaggerAutoTagRatingMinScore: settings.wdSwinTaggerAutoTagRatingMinScore,
      visionAutoTagCsvPath: settings.visionAutoTagCsvPath,
      visionAutoTagSampleImageCount: settings.visionAutoTagSampleImageCount,
      visionAutoTagOccurrenceThreshold: settings.visionAutoTagOccurrenceThreshold,
      visionAutoTagTemperature: settings.visionAutoTagTemperature,
      visionAutoTagTimeoutMs: settings.visionAutoTagTimeoutMs,
