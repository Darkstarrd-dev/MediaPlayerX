...
export function useAppSettingsStore() {
  return useUiStore(
    useShallow((state) => ({
      ...
      selectedGroupIdByMode: state.selectedGroupIdByMode,
      groupFilterEnabledByMode: state.groupFilterEnabledByMode,
      ...
      adReviewHashCompareStage: state.adReviewHashCompareStage,
      adReviewHashHitAction: state.adReviewHashHitAction,
