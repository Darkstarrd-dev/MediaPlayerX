...
export function useAppSettingsStore() {
  return useUiStore(
    useShallow((state) => ({
      ...
      wdSwinTaggerAutoTagGeneralMinScore: state.wdSwinTaggerAutoTagGeneralMinScore,
      wdSwinTaggerAutoTagCharacterMinScore: state.wdSwinTaggerAutoTagCharacterMinScore,
      wdSwinTaggerAutoTagIncludeRating: state.wdSwinTaggerAutoTagIncludeRating,
      wdSwinTaggerAutoTagRatingMinScore: state.wdSwinTaggerAutoTagRatingMinScore,
      visionAutoTagCsvPath: state.visionAutoTagCsvPath,
      visionAutoTagSampleImageCount: state.visionAutoTagSampleImageCount,
      visionAutoTagOccurrenceThreshold: state.visionAutoTagOccurrenceThreshold,
      visionAutoTagTemperature: state.visionAutoTagTemperature,
      visionAutoTagTimeoutMs: state.visionAutoTagTimeoutMs,
