...
function createDefaultMediaCapabilityHints(t: ReturnType<typeof useI18n>['t']): RuntimeMediaCapabilityHintDto[] {
  return [
    { id: 'h264-1080p', label: t('ui.settings.mediaCapability.h264Avc1080p'), content_type: 'video/mp4; codecs="avc1.640028"' },
    { id: 'hevc-1080p', label: t('ui.settings.mediaCapability.h265Hevc1080p'), content_type: 'video/mp4; codecs="hvc1.1.6.L120.B0"' },
    { id: 'av1-1080p', label: t('ui.settings.mediaCapability.av11080p'), content_type: 'video/mp4; codecs="av01.0.08M.08"' },
    { id: 'vp9-1080p', label: t('ui.settings.mediaCapability.vp91080p'), content_type: 'video/webm; codecs="vp09.00.41.08"' },
  ]
}
...
export function useRuntimeInfoDiagnostics(): RuntimeInfoDiagnosticsResult {
  ...
  useEffect(() => {
    const hints = data?.media_capability_hints ?? createDefaultMediaCapabilityHints(t)
