export const zhCnCatalogPart1 = {
  ...
  "ui.themeParameter.softPaneElevation": "Soft 面板浮起高度",
  "ui.themeParameter.headerFloatingGap": "Header 悬浮间距",
  "ui.themeParameter.softContainerElevation": "Soft 容器浮起高度",
  "ui.themeParameter.softControlElevation": "Soft 控件浮起高度",
  "ui.themeParameter.softBorderContrast": "Soft 边界对比度",
  "ui.themeParameter.softShadowStrength": "Soft 阴影强度",
  "ui.themeParameter.softPressDepth": "Soft 按压深度",
  ...
  "ui.sidebar.group.toggleFilter": "切换显示",
  "ui.sidebar.group.selectAriaLabel": "群组筛选",
  "ui.sidebar.group.addDialogTitle": "新建群组",
  "ui.sidebar.group.addDialogPlaceholder": "请输入群组名称",
  "ui.sidebar.group.deleteConfirmTitle": "确认删除",
  "ui.sidebar.group.deleteConfirmMessage":
    "确定要删除群组「{name}」吗？此操作不可撤销。",
  "ui.sidebar.group.duplicateName": "群组名「{name}」已存在",
  "ui.sidebar.group.emptyName": "群组名不能为空",
  "ui.fullscreen.groupPickerTitle": "加入群组",
  "ui.fullscreen.groupPickerCustom": "自定义...",
  "ui.fullscreen.groupPickerPlaceholder": "输入新群组名",
  "ui.fullscreen.groupPickerEmpty": "暂无群组",
  "ui.fullscreen.groupPickerHint": "↑↓ 导航  Enter 确认  Esc 取消",
  "tip.group.add": "添加新群组",
  "tip.group.delete": "删除当前选中群组",
  "tip.group.join": "将当前聚焦的图包或视频加入选中群组",
  "tip.group.remove": "将当前聚焦的媒体移出选中群组",
  "tip.group.toggleFilter": "切换左侧列表显示全部/当前群组",
  "tip.group.joinRemove": "加入或移除当前群组（+ 加入，- 移除）",
} as const;
