...
export const enUsCatalogPart1: Partial<{ [K in keyof ZhCnCatalog]: string }> = {
  ...
  "ui.themeParameter.softPaneElevation": "Soft pane elevation",
  "ui.themeParameter.headerFloatingGap": "Header floating gap",
  "ui.themeParameter.softContainerElevation": "Soft container elevation",
  "ui.themeParameter.softControlElevation": "Soft control elevation",
  "ui.themeParameter.softBorderContrast": "Soft border contrast",
  "ui.themeParameter.softShadowStrength": "Soft shadow strength",
  "ui.themeParameter.softPressDepth": "Soft press depth",
  ...
  "ui.sidebar.group.all": "All",
  "ui.sidebar.group.add": "Add Group",
  "ui.sidebar.group.delete": "Delete Group",
  "ui.sidebar.group.join": "Join",
  "ui.sidebar.group.remove": "Remove",
  "ui.sidebar.group.toggleFilter": "Toggle filter",
  "ui.sidebar.group.selectAriaLabel": "Group filter",
  "ui.sidebar.group.addDialogTitle": "New Group",
  "ui.sidebar.group.addDialogPlaceholder": "Enter group name",
  "ui.sidebar.group.deleteConfirmTitle": "Confirm Delete",
  "ui.sidebar.group.deleteConfirmMessage":
    'Are you sure you want to delete the group "{name}"? This action cannot be undone.',
  "ui.sidebar.group.duplicateName": 'Group name "{name}" already exists',
  "ui.sidebar.group.emptyName": "Group name cannot be empty",
  "ui.fullscreen.groupPickerTitle": "Add to Group",
  "ui.fullscreen.groupPickerCustom": "Custom...",
  "ui.fullscreen.groupPickerPlaceholder": "Enter a new group name",
  "ui.fullscreen.groupPickerEmpty": "No groups yet",
  "ui.fullscreen.groupPickerHint": "↑↓ navigate  Enter confirm  Esc cancel",
  "tip.group.add": "Add a new group",
  "tip.group.delete": "Delete the currently selected group",
  "tip.group.join": "Add the focused package or video to the selected group",
  "tip.group.remove": "Remove the focused media from the selected group",
  "tip.group.toggleFilter": "Toggle sidebar list between All and current group",
  "tip.group.joinRemove":
    "Join or remove current group (+ to join, - to remove)",
} as const;
