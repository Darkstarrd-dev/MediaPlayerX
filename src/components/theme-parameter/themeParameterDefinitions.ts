...
export const CONTAINER_FRAME_PARAMETERS: ThemeParameterDefinition[] = [
  createCssNumberParameter({
    id: "header-z-index",
    labelKey: "ui.themeParameter.headerZIndex",
    variableName: "--mpx-header-z-index",
    min: 0,
    max: 20,
    step: 1,
    fallback: 4,
  ...
  createCssDegreeParameter({
    id: "header-fill-angle",
    labelKey: "ui.themeParameter.containerFrameFillAngle",
    variableName: "--mpx-header-fill-angle",
    min: 0,
    max: 360,
    step: 1,
    fallback: 180,
  ...
  createCssNumberParameter({
    id: "sidebar-z-index",
    labelKey: "ui.themeParameter.sidebarZIndex",
    variableName: "--mpx-sidebar-z-index",
    min: 0,
    max: 20,
    step: 1,
    fallback: 2,
  ...
  createCssDegreeParameter({
    id: "sidebar-fill-angle",
    labelKey: "ui.themeParameter.containerFrameFillAngle",
    variableName: "--mpx-sidebar-fill-angle",
    min: 0,
    max: 360,
    step: 1,
    fallback: 180,
  ...
  createCssDegreeParameter({
    id: "main-fill-angle",
    labelKey: "ui.themeParameter.containerFrameFillAngle",
    variableName: "--mpx-main-fill-angle",
    min: 0,
    max: 360,
    step: 1,
    fallback: 180,
  ...
  createCssDegreeParameter({
    id: "main-header-fill-angle",
    labelKey: "ui.themeParameter.containerFrameFillAngle",
    variableName: "--mpx-main-header-fill-angle",
    min: 0,
    max: 360,
    step: 1,
    fallback: 180,
  ...
  createCssNumberParameter({
    id: "main-z-index",
    labelKey: "ui.themeParameter.mainZIndex",
    variableName: "--mpx-main-z-index",
    min: 0,
    max: 20,
    step: 1,
    fallback: 1,
  ...
  createCssDegreeParameter({
    id: "metadata-fill-angle",
    labelKey: "ui.themeParameter.containerFrameFillAngle",
    variableName: "--mpx-metadata-fill-angle",
    min: 0,
    max: 360,
    step: 1,
    fallback: 180,
  ...
  createCssDegreeParameter({
    id: "metadata-header-fill-angle",
    labelKey: "ui.themeParameter.containerFrameFillAngle",
    variableName: "--mpx-metadata-header-fill-angle",
    min: 0,
    max: 360,
    step: 1,
    fallback: 180,
  ...
  createCssNumberParameter({
    id: "metadata-z-index",
    labelKey: "ui.themeParameter.metadataZIndex",
    variableName: "--mpx-metadata-z-index",
    min: 0,
    max: 20,
    step: 1,
    fallback: 2,
...
export const LARGE_PANEL_PARAMETERS: ThemeParameterDefinition[] = [
  ...
  createCssDegreeParameter({
    id: "large-panel-fill-angle",
    labelKey: "ui.themeParameter.largePanelFillAngle",
    variableName: "--mpx-large-panel-fill-angle",
    min: -180,
    max: 180,
    step: 1,
    fallback: 180,
  ...
  createCssDegreeParameter({
    id: "large-panel-section-fill-angle",
    labelKey: "ui.themeParameter.largePanelSectionFillAngle",
    variableName: "--mpx-large-panel-section-fill-angle",
    min: -180,
    max: 180,
    step: 1,
    fallback: 180,
  ...
  createCssPxParameter({
    id: "large-panel-section-border-width",
    labelKey: "ui.themeParameter.largePanelSectionBorderWidth",
    variableName: "--mpx-large-panel-section-border-width",
    min: 0,
    max: 6,
    step: 1,
    fallback: 1,
  ...
  createCssDegreeParameter({
    id: "large-panel-head-fill-angle",
    labelKey: "ui.themeParameter.largePanelHeadFillAngle",
    variableName: "--mpx-large-panel-head-fill-angle",
    min: -180,
    max: 180,
    step: 1,
    fallback: 180,
  ...
  createCssDegreeParameter({
    id: "large-panel-side-fill-angle",
    labelKey: "ui.themeParameter.largePanelSideFillAngle",
    variableName: "--mpx-large-panel-side-fill-angle",
    min: -180,
    max: 180,
    step: 1,
    fallback: 180,
  ...
  createCssDegreeParameter({
    id: "large-panel-main-fill-angle",
    labelKey: "ui.themeParameter.largePanelMainFillAngle",
    variableName: "--mpx-large-panel-main-fill-angle",
    min: -180,
    max: 180,
    step: 1,
    fallback: 180,
