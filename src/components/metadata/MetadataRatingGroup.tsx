      ...
      >
        ...
        >
          <button
            ...
            data-tooltip-label={t('a11y.metadata.ratingNoneWithGroup', { group: groupAriaLabel })}
          ...
          {[1, 2, 3, 4, 5].map((score) => {
            ...
            return (
              <button
                ...
                data-tooltip-label={t('a11y.metadata.ratingStarsWithGroup', { group: groupAriaLabel, score })}
