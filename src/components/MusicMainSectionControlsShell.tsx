      ...
      <div className="music-controls-row">
        <div className="music-controls-group is-left mpx-soft-well" data-slot="fg-main-content-music-controls-left">
          ...
          >
            ...
            <div
              className="music-ctrl-panel is-shader"
              data-slot="fg-main-content-music-controls-shader-pop"
              hidden={!popoverDebugPinned && openPopover !== 'shader'}
              id="music-main-popover-shader"
              role="dialog"
              style={shaderOptionWidthStyle}
            >
