    ...
    <div className="settings-block">
        ...
        <fieldset className="settings-subsection">
          ...
          {subtitleRenderMode === "advanced" ? (
            <details className="settings-collapsible" open>
              <summary>
                {t("ui.settings.offlineSubtitleAdvancedSection")}
              </summary>
              <div className="settings-collapsible-content">
                <label
                  data-tooltip-label={settingsTip("offlineSubtitleVadPreset")}
                >
                ...
                <label
                  data-tooltip-label={settingsTip(
                    "offlineSubtitleVadMinSilenceSec",
                  )}
                >
                ...
                <label
                  data-tooltip-label={settingsTip(
                    "offlineSubtitleVadMinSpeechSec",
                  )}
                >
                ...
                <label
                  data-tooltip-label={settingsTip(
                    "offlineSubtitleVadMaxSpeechSec",
                  )}
                >
                ...
                <label
                  data-tooltip-label={settingsTip(
                    "offlineSubtitleSpeakerThreshold",
                  )}
                >
                ...
                <label
                  data-tooltip-label={settingsTip(
                    "offlineSubtitleValidPlaybackRateThreshold",
                  )}
                >
          ...
          <label
            data-tooltip-label={settingsTip("offlineSubtitleModelProfile")}
          >
          ...
          <label data-tooltip-label={settingsTip("offlineSubtitleModelDir")}>
            ...
            <div className="settings-inline-field">
              <input
                ...
                readOnly
                placeholder={t(
                  "ui.settings.offlineSubtitleModelDirPlaceholder",
                )}
              />
          ...
          >
            ...
            <div className="settings-collapsible-content">
              <label
                data-tooltip-label={settingsTip("offlineSubtitleTextFillMode")}
              >
              ...
              {subtitleTextFillMode === "solid" ? (
                <label
                  data-tooltip-label={settingsTip("offlineSubtitleTextColor")}
                >
                ...
                <>
                  <label
                    data-tooltip-label={settingsTip(
                      "offlineSubtitleGradientStartColor",
                    )}
                  >
                  ...
                  <label
                    data-tooltip-label={settingsTip(
                      "offlineSubtitleGradientEndColor",
                    )}
                  >
                  ...
                  <label
                    data-tooltip-label={settingsTip(
                      "offlineSubtitleGradientDirection",
                    )}
                  >
              ...
              <label
                data-tooltip-label={settingsTip("offlineSubtitleStrokeColor")}
              >
              ...
              <label
                data-tooltip-label={settingsTip("offlineSubtitleStrokeWidth")}
              >
              ...
              <label
                data-tooltip-label={settingsTip("offlineSubtitleFontSize")}
              >
              ...
              <label
                data-tooltip-label={settingsTip("offlineSubtitleMaxLineChars")}
              >
              ...
              <label
                data-tooltip-label={settingsTip(
                  "offlineSubtitleStrokeShadowColor",
                )}
              >
              ...
              <label
                data-tooltip-label={settingsTip(
                  "offlineSubtitleStrokeShadowRadius",
                )}
              >
          ...
          <div className="settings-test-row">
            <button
              ...
              data-tooltip-label={t(
                "ui.settings.offlineSubtitleRescanDirectory",
              )}
            ...
            <button
              ...
              data-tooltip-label={t(
                "ui.settings.offlineSubtitleCancelDownload",
              )}
      ...
      {sectionMode === "ai" ? (
        <fieldset className="settings-subsection">
          ...
          <label data-tooltip-label={settingsTip("adReviewExecutionMode")}>
            {t("ui.settings.adReviewExecutionMode")}
            <select
              value={adReviewExecutionMode}
              onChange={(event) =>
                onAdReviewExecutionModeChange(
                  event.target.value as "normal" | "performance",
                )
              }
            >
              <option value="normal">
                {t("ui.settings.adReviewModeNormal")}
              </option>
              <option value="performance">
                {t("ui.settings.adReviewModePerformance")}
              </option>
            </select>
          </label>
      ...
      {sectionMode === "video" ? (
        <fieldset className="settings-subsection">
          ...
          <details className="settings-collapsible">
            <summary>
              {t("ui.settings.subtitleCleanupLlmPromptSection")}
            </summary>
            <div className="settings-collapsible-content">
              <label
                data-tooltip-label={settingsTip("subtitleCleanupLlmPrompt")}
              >
