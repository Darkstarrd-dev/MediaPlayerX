...
function renderShortcutBinding(
...
function HelpPanel({
  ...
  const { panelOffset, panelDragging, headHandlers } =
    useDraggablePanel(helpOpen);

  const imageModeShortcutRows = useMemo(
    () => [
      {
        key: "image-left-right",
        shortcut: renderShortcutBinding(
          shortcuts.imagePrev,
          t("ui.help.shortcutNotSet"),
        ),
      ...
      },
      {
        ...
        shortcut: renderShortcutBinding(
          shortcuts.windowFullscreenToggle,
          t("ui.help.shortcutNotSet"),
        ),
      ...
      {
        key: "theme-parameter-temporary-hide",
        shortcut: t("ui.help.image.keyboard.fixedThemeParameterHideShortcut"),
        action: t("ui.help.image.keyboard.themeParameterTemporaryHide"),
      },
    ],
    [shortcuts, t],
  );
  ...
  return (
    <div
      ...
      data-slot="fg-header-g3-help-root-ovl"
      role="dialog"
      aria-modal="true"
        ...
        <div className="mpx-large-panel-shell settings-shell">
          ...
          <main className="mpx-large-panel-main settings-main mpx-scroll-area">
            {activeSection === "image" ? (
              <section className="settings-block help-block">
                <p className="settings-group-head">
                  {t("ui.help.image.sectionTitle")}
                </p>

                <div className="settings-group">
                  <p className="help-group-title">
                    {t("ui.help.image.groupMouse")}
                  </p>
                  <ul
                    className="help-list"
                    aria-label={t("a11y.help.imageMouseList")}
                  >
                ...
                <div className="settings-group">
                  <p className="help-group-title">
                    {t("ui.help.image.groupKeyboard")}
                  </p>
                  <ul
                    className="help-list"
                    aria-label={t("a11y.help.imageKeyboardList")}
                  >
                    {imageModeShortcutRows.map((row) => (
                      <li key={row.key} className="help-shortcut-row">
                        <span className="help-shortcut-chip">
                          {row.shortcut}
                        </span>
            ...
            {activeSection === "fullscreen" ? (
              <section className="settings-block help-block">
                <p className="settings-group-head">
                  {t("ui.help.fullscreen.sectionTitle")}
                </p>

                <div className="settings-group">
                  <p className="help-group-title">
                    {t("ui.help.fullscreen.groupMouse")}
                  </p>
                  <ul
                    className="help-list"
                    aria-label={t("a11y.help.fullscreenMouseList")}
                  >
                    ...
                    <li>
                      {t("ui.help.fullscreen.mouse.moveBottomShowFooter")}
                    </li>
                  </ul>
                </div>
                ...
                <div className="settings-group">
                  <p className="help-group-title">
                    {t("ui.help.fullscreen.groupKeyboard")}
                  </p>
                  <ul
                    className="help-list"
                    aria-label={t("a11y.help.fullscreenKeyboardList")}
                  >
            ...
            {activeSection === "adReviewStrategy" ? (
              <section className="settings-block help-block">
                <p className="settings-group-head">
                  {t("ui.help.adReviewStrategy.sectionTitle")}
                </p>

                <div className="settings-group">
                  <p className="help-group-title">
                    {t("ui.help.adReviewStrategy.groupOverview")}
                  </p>
                  <ul
                    className="help-list"
                    aria-label={t("a11y.help.adReviewStrategyOverviewList")}
                  >
                    <li>{t("ui.help.adReviewStrategy.overview.modeAll")}</li>
                    <li>
                      {t("ui.help.adReviewStrategy.overview.modeHeadTail")}
                    </li>
                    <li>
                      {t("ui.help.adReviewStrategy.overview.knownHashFirst")}
                    </li>
                  </ul>
                </div>
                ...
                <div className="settings-group">
                  <p className="help-group-title">
                    {t("ui.help.adReviewStrategy.groupHeadTailFlow")}
                  </p>
                  <ul
                    className="help-list"
                    aria-label={t("a11y.help.adReviewStrategyFlowList")}
                  >
                ...
                <div className="settings-group">
                  <p className="help-group-title">
                    {t("ui.help.adReviewStrategy.groupDefaults")}
                  </p>
                  <ul
                    className="help-list"
                    aria-label={t("a11y.help.adReviewStrategyDefaultsList")}
                  >
                    <li>
                      {t("ui.help.adReviewStrategy.defaults.strategyMode")}
                    </li>
                    ...
                    <li>
                      {t("ui.help.adReviewStrategy.defaults.maxConcurrency")}
                    </li>
                  </ul>
                </div>
                ...
                <div className="settings-group">
                  <p className="help-group-title">
                    {t("ui.help.adReviewStrategy.groupRiskAndUsage")}
                  </p>
                  <ul
                    className="help-list"
                    aria-label={t("a11y.help.adReviewStrategyRiskList")}
                  >
                    <li>{t("ui.help.adReviewStrategy.risk.middleLeak")}</li>
                    <li>{t("ui.help.adReviewStrategy.risk.whenUseAll")}</li>
                    <li>
                      {t("ui.help.adReviewStrategy.risk.whenUseHeadTail")}
                    </li>
                  </ul>
                </div>
              </section>
