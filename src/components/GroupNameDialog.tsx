...
function GroupNameDialog({
  ...
  return (
    <div className="settings-floating-mask" data-slot="fg-main-header-manage-group-name-ovl" role="dialog" aria-modal="true" aria-label={inputLabel} data-overlay-close="group-name-dialog">
      <section className="settings-floating-panel manage-group-dialog" data-slot="fg-main-header-manage-group-name-panel" role="document" style={{ width: `min(92vw, max(270px, ${dialogWidthCh}))` }}>
        <input
