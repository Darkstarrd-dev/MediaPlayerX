...
| `31-ad-review-performance-mode-implementation-plan-v1.md` | 当前计划（待校准） | 广告审核性能模式实施方案历史草案（完成勾选需按恢复文档复核） |
...
| 路径 | 用途 |
|---|---|
| `ref/ad-review-data/INDEX.md` | 广告审核实验脚本与结果总索引 |
| `ref/ad-review-data/RECOVERED_PROGRESS_AND_REIMPLEMENTATION_GUIDE.md` | 进度找回、方案纠偏与重实施指引 |
