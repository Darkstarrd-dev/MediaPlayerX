...
describe('themeGalleryCaptureRuntime selectors', () => {
  it('prefers stable data-a11y-id selectors for app controls', () => {
    ...
    expect(script).toContain('button[data-a11y-id="metadata.toolbar.g3.search"]')
    expect(script).toContain('button[data-a11y-id="metadata.toolbar.g3.manage"]')
    expect(script).toContain('button[data-a11y-id="metadata.toolbar.g3.metadataToggle"]')
