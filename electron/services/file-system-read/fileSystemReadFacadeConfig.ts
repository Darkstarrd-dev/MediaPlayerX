...
export const DIRECTORY_SCAN_CONCURRENCY = resolveConcurrency(
  process.env.MEDIA_PLAYERX_SCAN_CONCURRENCY,
  16,
  64,
);

export const ARCHIVE_SCAN_CONCURRENCY = resolveConcurrency(
  process.env.MEDIA_PLAYERX_ARCHIVE_SCAN_CONCURRENCY,
  10,
  32,
);

export const ARCHIVE_NORMALIZE_IDLE_MS = resolveConcurrency(
  process.env.MEDIA_PLAYERX_ARCHIVE_NORMALIZE_IDLE_MS,
  1800,
  10_000,
);

export const ARCHIVE_NORMALIZE_RECHECK_MS = resolveConcurrency(
  process.env.MEDIA_PLAYERX_ARCHIVE_NORMALIZE_RECHECK_MS,
  400,
  5_000,
);

export const FFPROBE_CONCURRENCY = resolveConcurrency(
  process.env.MEDIA_PLAYERX_FFPROBE_CONCURRENCY,
  3,
  8,
);

export const GLOBAL_CPU_TOKEN_LIMIT = resolveConcurrency(
  process.env.MEDIA_PLAYERX_CPU_TOKEN_LIMIT,
  1,
  16,
);

export const GLOBAL_GPU_TOKEN_LIMIT = resolveConcurrency(
  process.env.MEDIA_PLAYERX_GPU_TOKEN_LIMIT,
  1,
  8,
);

export const AUDIO_TRANSCODE_CONCURRENCY = resolveConcurrency(
  resolveFirstEnvValue(
    "MPX_AUDIO_TRANSCODE_CONCURRENCY",
    "MEDIA_PLAYERX_AUDIO_TRANSCODE_CONCURRENCY",
  ),
  1,
  2,
);
