export const BACKEND_CHANNELS = {
  ...
  readManageAdReviewKnownHashes: "backend:readManageAdReviewKnownHashes",
  importManageAdReviewKnownHashes: "backend:importManageAdReviewKnownHashes",
  exportManageAdReviewKnownHashes: "backend:exportManageAdReviewKnownHashes",
  ...
  startVideoTranscodeTask: "backend:startVideoTranscodeTask",
  estimateVideoTranscodeOutputSize: "backend:estimateVideoTranscodeOutputSize",
  readVideoTranscodeCapabilities: "backend:readVideoTranscodeCapabilities",
  readVideoTranscodeTask: "backend:readVideoTranscodeTask",
  cancelVideoTranscodeTask: "backend:cancelVideoTranscodeTask",
  ...
  externalAuthConnect: "backend:externalAuthConnect",
  externalAuthDisconnect: "backend:externalAuthDisconnect",
  externalAuthStatus: "backend:externalAuthStatus",
  ...
  verifyAudioTranscodeFfmpegBin: "backend:verifyAudioTranscodeFfmpegBin",
  ...
  readAudioEngineAnalysisFrame: "backend:readAudioEngineAnalysisFrame",
...
export type BackendChannelName =
  (typeof BACKEND_CHANNELS)[keyof typeof BACKEND_CHANNELS];

export type BenchChannelName =
  (typeof BENCH_CHANNELS)[keyof typeof BENCH_CHANNELS];

export type AppWindowChannelName =
  (typeof APP_WINDOW_CHANNELS)[keyof typeof APP_WINDOW_CHANNELS];
